...
<script src="<c:url value='../assets/js/bootstrap.min.js'/>"
	type="text/javascript"> </script> <!--  Charts Plugin --> <script
	src="<c:url value='../assets/js/chartist.min.js' />"></script> <!--  Notifications Plugin    -->
<script src="<c:url value='../assets/js/bootstrap-notify.js' />"></script>

<!--  Google Maps Plugin    --> <script type="text/javascript"
