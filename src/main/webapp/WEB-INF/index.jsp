...
<!--      Light Bootstrap Table core CSS    -->
    <link href="<c:url value='../assets/css/light-bootstrap-dashboard.css?v=1.4.0' />"  rel="stylesheet"/>
...
<div class="wrapper">
    <div class="sidebar" data-color="purple" data-image="<c:url value='../assets/img/desayuno.jpg'/> ">
...
<!--         </div> -->
    ...
    <scritp src="<c:url value='../assets/js/bootstrap.min.js'/>" type="text/javascript"></script>
